...
import 'package:simpleanimations/ui/animations/slide_in_screen.dart';
...
class SimpleAnimationRoutes {
  ...
  static const slideIn = 'slide-in-animation';
  static const slideOut = 'slide-out-animation';
  ...
  static Map<String, Widget Function(BuildContext)> routes =
    ...
    slideIn: (_) => const SlideInScreen(),
    slideOut: (_) => const SlideInScreen(isOpposite: true),
  };
}
